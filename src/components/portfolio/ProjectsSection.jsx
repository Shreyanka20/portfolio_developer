...
const projects = [
  {
    id: "01",
    name: "Florra AI",
    description: "AI-powered dating assistant within the Flutrr ecosystem — matchmaking, conversation guidance, and personalized user engagement through full-stack AI workflows.",
    imageUrl: "https://media.base44.com/images/public/6a2a6bb22076cf135bcee9e0/9520d11f1_ChatGPTImageJun23202609_52_25PM.png",
    layout: "image-left",
  },
  {
    id: "02",
    name: "Flutrr Official Website",
    description: "Production-ready marketing website — polished, fast, and fully responsive across desktop and mobile to strengthen Flutrr's online presence.",
  ...
  },
  {
    id: "03",
    name: "Glodobaara",
    description: "E-commerce mobile app with a clean interface, secure payments, and personalized recommendations — intuitive shopping flows end to end.",
  ...
  },
  {
    id: "04",
    name: "Homi AI",
    description: "Multi-channel AI content platform — generate marketing copy for Instagram, LinkedIn, blogs, email campaigns, and brand assets from one workflow.",
  ...
  },
  {
    id: "05",
    name: "Rasoi",
    description: "Real-time restaurant operations platform with four role-based dashboards — digitizing the full dine-in journey from OTP login to billing and reviews.",
  ...
  },
  {
    id: "06",
    name: "Bloomkeep",
    description: "Mobile-first digital gifting platform — build and share living bouquets with music, animation, and a tap-to-reveal experience, no signup required.",
  ...
  },
  {
    id: "07",
    name: "ChronoBook",
    description: "Calendly-style scheduling platform — public booking pages, conflict detection, automated confirmations, and shareable links with no invitee account needed.",
    imageUrl: "/images/chronobook.png",
    layout: "image-left",
  },
];
